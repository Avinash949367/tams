...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        <title>Monopoly Event - Interactive Game</title>
        <meta name="description" content="Join the exciting Monopoly event with real-time gameplay and team competition" />
      </head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="md:hidden">
                <button 
                  className="p-2 rounded-md text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
